...
namespace GameEngineTests
{
    ...
    public class Form1Test
    {
        ...
        /// <summary>
        ///A test for _openGLControl_Load
        ///</summary>
        [TestMethod()]
        [DeploymentItem("GameEngine.exe")]
        public void _openGLControl_LoadTest()
        {
            Form1_Accessor target = new Form1_Accessor(); // TODO: Initialize to an appropriate value
            object sender = null; // TODO: Initialize to an appropriate value
            EventArgs e = null; // TODO: Initialize to an appropriate value
            target._openGLControl_Load(sender, e);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }

        /// <summary>
        ///A test for _openGLControl_Paint
        ///</summary>
        [TestMethod()]
        [DeploymentItem("GameEngine.exe")]
        ...
        /// <summary>
        ///A test for _openGLControl_Resize
        ///</summary>
        [TestMethod()]
        [DeploymentItem("GameEngine.exe")]
        public void _openGLControl_ResizeTest()
        {
            Form1_Accessor target = new Form1_Accessor(); // TODO: Initialize to an appropriate value
            object sender = null; // TODO: Initialize to an appropriate value
            EventArgs e = null; // TODO: Initialize to an appropriate value
            target._openGLControl_Resize(sender, e);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }
    }
}
